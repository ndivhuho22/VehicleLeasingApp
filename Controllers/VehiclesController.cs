...
namespace VehicleLeasingApp.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        {
            ViewBag.BranchId = new SelectList(db.Branches, "BranchId", "Location");
        ...
        public ActionResult Create([Bind(Include = "VehicleId,Manufacturer,SupplierId,BranchId,ClientId,DriverId")] Vehicle vehicle)
        {
            ...
            ViewBag.BranchId = new SelectList(db.Branches, "BranchId", "Location", vehicle.BranchId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleId,Manufacturer,SupplierId,BranchId,ClientId,DriverId")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
